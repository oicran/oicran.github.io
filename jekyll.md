...
Os artigos a seguir são uma tradução livre da documentação oficial do Jekyll que está referida em cada página.

 * [Quick-start guide](./jekyll-GS_Quick-start_guide.html)

 * [Instalando o Jekyll](./jekyll-GS_Installation.html)
